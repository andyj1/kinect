...
%% read in the data
onedev = readtable('./1_angles.csv'); onedev = onedev(:,2:13);
twodev = readtable('./2_angles.csv'); twodev = twodev(:,2:13);
threedev = readtable('./3_angles.csv'); threedev = threedev(:,2:13);
