...
#depth engine file (backup): 
wget --no-check-certificate 'https://drive.google.com/open?id=1nryM1mghLDAp64F-RMdruirotcDH7U6c' -O libdepthengine.so.2.0

#copy to Azure-Kinect-Sensor-SDK/build/bin
cp libdepthengine.so.2.0 Azure-Kinect-Sensor-SDK/build/bin
